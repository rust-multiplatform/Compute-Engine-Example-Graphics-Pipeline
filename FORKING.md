...
We have a [base template/example](https://github.com/rust-multiplatform/Compute-Engine-Example-Graphics-Pipeline).  
...
On GitHub on our [base template/example](https://github.com/rust-multiplatform/Compute-Engine-Example-Graphics-Pipeline) at the top right corner is a "Fork" button.
...
3. Add a secondary remote commonly called `upstream` with the base project url: `git remote add upstream https://github.com/rust-multiplatform/Compute-Engine-Example-Graphics-Pipeline`
